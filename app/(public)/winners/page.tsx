import { WINNERS, LOTTERIES, formatMNT, formatDate } from "@/lib/mock-data";
...
export default function WinnersPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 pb-12">
      ...
      {/* Ended lotteries without winners shown yet */}
      <div className="mt-12">
            ...
            return (
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-sm font-medium text-gray-900">{formatMNT(lottery.prizeValue)}</p>
                  {winner ? (
